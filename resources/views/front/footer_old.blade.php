    ...
    <footer class="footer">
        <div class="footer-wrapper">
            ...
            <div class="footer-block">
                <ul>
                    <li>
                        <p class="footer-text">Запись на процедуры</p>
                        <p class="big-phone ringo-phone">
                    ...
                    <li class="wa-block">
                        <p class="footer-text">
                            <span class="phone phone-wa">
                                <a href="https://wa.me/{{str_replace(['+', ' ', '(', ')', '-'], '', $all_site->whatsapp)}}" class="phone-link">{{$all_site->whatsapp}}</a>
                            </span>
                        </p>
                    </li>
                </ul>
