...
@include('front.menu')
@section('content')
@include('front.meta', ['meta_description' => $quest->seo_description_field, 'meta_keywords' => $quest->seo_keywords_field])
    <?php $title = $quest->page_title_field ?>
    <div class="content-head questions-page" style="background: url(/images/{{$quest->background_image->primary_link}}) no-repeat center top;">
