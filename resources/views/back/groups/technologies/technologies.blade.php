        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab_g1">
                                        ...
                                        <div class="file-preview-frame">
                                            ...
                                            <div class="file-thumbnail-footer">
                                                <div class="file-actions">
                                                    <input type="text" class="form-control alt-text" data-block="technologies"
                ...
                <div class="box box-info group-item-widget" data-block="tech_pokazania">
                    ...
                    <div class="box-body">
                        <div class="groupflat-widget group-item-wrap">
                            @foreach($item->tech_pokazania_group as $pok_item)
                                @include('back.groups.tech_pokazania.tech_pokazania_box', ['item' => $pok_item])
                            @endforeach
                        </div>
                    </div>
                </div>

                <div class="box box-info group-item-widget" data-block="tech_protivopokazania">
                    <div class="box-header with-border">
                    ...
                    <div class="box-body">
                        <div class="groupflat-widget group-item-wrap">
                            @foreach($item->tech_protivopokazania_group as $pr_item)
                                @include('back.groups.tech_protivopokazania.tech_protivopokazania_box', ['item' => $pr_item])
                            @endforeach
                        </div>
                    </div>
                </div>
                ...
                {{--<div class="box box-info group-item-widget" data-block="tech_after_proc">
                    ...
                    <div class="box-body">
                        <div class="groupflat-widget group-item-wrap">
                            @foreach($item->tech_after_proc_group as $aft_item)
                                @include('back.groups.tech_after_proc.tech_after_proc_box', ['item' => $aft_item])
                            @endforeach
                        </div>
                    </div>
                </div>--}}
                ...
                {{--<div class="box box-info group-item-widget" data-block="tech_effect_up">
                    ...
                    <div class="box-body">
                        <div class="groupflat-widget group-item-wrap">
                            @foreach($item->tech_effect_up_group as $up_item)
                                @include('back.groups.tech_effect_up.tech_effect_up_box', ['item' => $up_item])
                            @endforeach
                        </div>
                    </div>
                </div>--}}
