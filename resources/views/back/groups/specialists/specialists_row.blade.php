<tr role="row" class="odd" data-id="{{$item->id_field}}">
    ...
    {{-- Название  --}}
    <td class="sorting_1">
        <a href="specialists/{{$item->id_field}}" class="">{{$item->spec_name_field}}</a>
    </td>
    ...
    {{-- Удаления  --}}
    <td>
        <button type="button" class="btn btn-block btn-primary group-remove-item" data-id="{{$item->id_field}}" data-block="specialists">Удалить</button>
    </td>
</tr>